<script>
  ...
  $: if ($journey.depart && ($journey.isReturn ? $journey.return : true)) {
    $uiStage = 'review'
  }
    ...
    <div class="border border-slate-300 rounded-md">
      ...
      <div class="panel px-3" class:hide="{$uiStage != 'locations'}">
        ...
        <div class="pt-1 pb-3 flex justify-between">
          ...
          <button type="button" class="border-b border-slate-300 inline-flex items-center px-4 py-2 border border-transparent text-m font-medium rounded-md shadow-sm text-white bg-slate-600 hover:bg-slate-600" on:click="{ () => { $uiStage = 'schedule'} }">Continue</button>
        </div>
    ...
    <div class=" mt-6 border border-slate-300 rounded-md">
      ...
      <div class="panel px-3" class:hide="{$uiStage != 'schedule'}">
        ...
        <div class="pt-1 pb-3 flex justify-between">
          ...
          <button type="button" class="border-b border-slate-300 inline-flex items-center px-4 py-2 border border-transparent text-m font-medium rounded-md shadow-sm text-white bg-slate-600 hover:bg-slate-600" on:click="{ () => { $uiStage = 'review'} }">Continue</button>
        </div>
